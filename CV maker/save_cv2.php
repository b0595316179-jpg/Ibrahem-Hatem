...
<body class="flex flex-col lg:flex-row items-start justify-center min-h-screen p-4 gap-6">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg w-full lg:w-1/2 max-w-2xl overflow-y-auto max-h-[95vh]">
        ...
        <div class="mb-6 pb-4 border-b border-gray-200">
            <h2 class="text-2xl font-semibold text-gray-700 mb-4">Load Template</h2>
            <div class="flex flex-wrap gap-4">
                <button id="template1Btn" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out">Software Engineer Template</button>
                <button id="template2Btn" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out">Marketing Specialist Template</button>
            </div>
        </div>
    ...
    <script>
        ...
        const cvTemplates = {
            'softwareEngineer': {
                personal: {
                    ...
                    linkedin: 'https://linkedin.com/in/janedoe-se',
                    portfolio: 'https://janedoe-portfolio.com',
                    summary: 'Highly motivated Software Engineer with 5+ years of experience in developing scalable web applications using modern JavaScript frameworks and backend technologies. Proven ability to deliver high-quality code and collaborate effectively within agile teams.'
                },
                education: [
                    {
                ...
                experience: [
                    {
                        ...
                        startDate: '2022-06',
                        endDate: '', // Empty for 'Present'
                        responsibilities: 'Led development of new microservices using Node.js and AWS Lambda.\nOptimized database queries, reducing response times by 30%.\nMentored junior developers and conducted code reviews.'
                    },
                    {
                        ...
                        startDate: '2020-06',
                        endDate: '2022-05',
                        responsibilities: 'Developed responsive front-end interfaces with React and Redux.\nImplemented RESTful APIs with Python and Django.\nParticipated in daily stand-ups and sprint planning.'
                    }
                ],
                skills: [
                    {
                    ...
                    },
                    {
                        ...
                        items: ['React', 'Node.js', 'Django', 'Spring Boot', 'Tailwind CSS']
                    },
                    {
                        category: 'Databases',
                    ...
                    },
                    {
                        ...
                        items: ['Git', 'Docker', 'AWS', 'Jira', 'Agile/Scrum']
                    }
                ]
            },
            'marketingSpecialist': {
                personal: {
                    ...
                    linkedin: 'https://linkedin.com/in/davidlee-marketing',
                    portfolio: 'https://davidlee-marketing.com',
                    summary: 'Dynamic Marketing Specialist with 7 years of experience in digital marketing, content strategy, and campaign management. Adept at leveraging data analytics to drive brand awareness and achieve measurable ROI.'
                },
                education: [
                    {
                        institution: 'Business School of America',
                        degree: 'MBA',
                        major: 'Marketing',
                        startDate: '2017-09',
                        endDate: '2019-05'
                ...
                experience: [
                    {
                        ...
                        startDate: '2021-03',
                        endDate: '',
                        responsibilities: 'Developed and executed comprehensive digital marketing strategies across SEO, SEM, social media, and email.\nManaged a marketing budget of $500K, achieving 20% growth in lead generation.\nAnalyzed campaign performance using Google Analytics and CRM data.'
                    },
                    {
                        ...
                        startDate: '2019-06',
                        endDate: '2021-02',
                        responsibilities: 'Created engaging blog posts, articles, and social media content.\nManaged social media presence across multiple platforms, increasing engagement by 40%.\nCollaborated with sales team to align marketing efforts with business goals.'
                    }
                ],
                skills: [
                    {
                        category: 'Digital Marketing',
                        items: ['SEO/SEM', 'Content Marketing', 'Social Media Marketing', 'Email Marketing', 'Google Ads', 'Facebook Ads']
                    },
                    {
                        category: 'Analytics & Tools',
                        items: ['Google Analytics', 'CRM Software', 'Mailchimp', 'Hootsuite', 'SEMrush']
                    },
                    {
                        category: 'Soft Skills',
                        items: ['Strategic Planning', 'Communication', 'Team Collaboration', 'Project Management', 'Data Analysis']
                    }
                ]
            }
        };
        ...
        function populateFormWithCVData() {
            ...
            // Add one empty field if no education entries exist in the data
            if (cvData.education.length === 0) addEducationField();

            // Populate Experience
            cvData.experience.forEach(exp => addExperienceField(exp));
            // Add one empty field if no experience entries exist in the data
            if (cvData.experience.length === 0) addExperienceField();

            // Populate Skills
            cvData.skills.forEach(skill => addSkillCategoryField(skill));
            // Add one empty field if no skill entries exist in the data
            if (cvData.skills.length === 0) addSkillCategoryField();
        ...
        /**
         * Loads a predefined CV template into the form and preview.
         * @param {string} templateName The key of the template to load from cvTemplates.
         */
        function loadTemplate(templateName) {
            if (cvTemplates[templateName]) {
                cvData = JSON.parse(JSON.stringify(cvTemplates[templateName])); // Deep copy the template data
                populateFormWithCVData();
                showMessageBox(`Template "${templateName}" loaded successfully!`);
            } else {
                showMessageBox(`Template "${templateName}" not found.`);
            }
        }

        template1Btn.addEventListener('click', () => loadTemplate('softwareEngineer'));
        template2Btn.addEventListener('click', () => loadTemplate('marketingSpecialist'));
